"""
Django settings for teleconsult_project project.
...
SECRET_KEY = 'django-insecure-3%e2e3z#^ex&ng49=ez!n-sctb(vi&3%sm7*98)py0tt&m+=t&'
...
ROOT_URLCONF = 'teleconsult_project.urls'
...
WSGI_APPLICATION = 'teleconsult_project.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / "db.sqlite3",  # Emplacement du fichier SQLite
    }
}
